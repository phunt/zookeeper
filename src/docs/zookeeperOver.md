...
Applications {#ch_DesignOverview}
...
[ZooKeeper Components](#fg_zkComponents) shows the high-level components
...
#### ZooKeeper Components {#fg_zkComponents}
...
that it is. (See [ZooKeeper Throughput as the Read-Write Ratio Varies](#fg_zkPerfRW).) It is especially high
...
#### ZooKeeper Throughput as the Read-Write Ratio Varies {#fg_zkPerfRW}

![](images/zkperfRW-3.2.jpg)

The figure [ZooKeeper Throughput as the Read-Write Ratio Varies](#fg_zkPerfRW) is a throughput
...
In version 3.2 r/w performance improved by ~2x
compared to the [previous
3.1 release](http://zookeeper.apache.org/docs/r3.1.1/zookeeperOver.html#Performance).
</div>
</div>

Benchmarks also indicate that it is reliable, too. [Reliability in the Presence of Errors](#fg_zkPerfReliability) shows how a deployment responds to
...
workloads.
{anchor:zkPerfReliability}

#### Reliability in the Presence of Errors {#fg_zkPerfReliability}

![](images/zkperfreliability.jpg)
